...
public class StateCensusAnalyser {
    ...
    public static void getFileExtension(File getPaths) throws StateCensusAnalyserException {
        ...
        if (!(extension.equals("csv"))) {
            throw new StateCensusAnalyserException(StateCensusAnalyserException.Exceptiontype.ENTERED_WRONG_FILE_TYPE, "FILE TYPE  INCORRECT");
        }
    }
    ...
    private static <E> Iterator<E> getCSVFileIterator(Reader reader, Class csvClass) throws StateCensusAnalyserException {
        try {
            ...
            throw new StateCensusAnalyserException(StateCensusAnalyserException.Exceptiontype.UNABLE_TO_PARSE, e.getMessage());
        }
    }
}
